...
server = function(input, output, session) {
  ...
  student_quiz <- reactive({
    ...
    quiz_clean %>%
      filter(YEAR == input$student_year, STUDENT_KEY == as.numeric(input$student_id)) %>%
  ...
  output$stu.plot1 = renderPlot({
    ...
    ggplot(plot_df, aes(x = QUIZ_NUMBER)) +
      ...
      scale_fill_manual(values = c("Class average" = "#E15759", "Student" = "#4E79A7")) +
